...
class AddMoneyController extends Controller
{
 ...
 public function payWithStripe($id, $sponsor_id=null)
 {
 	...
 	$team_id=9;
  return view('test_stripe',compact('team_id'));
...
//	 die(); 
		...
		if($request->get('stripeToken')) {
			Stripe::setApiKey('sk_test_51I3HHDJjnWbuZjcvlgeI2HvsxqMs9Xm5g0iCqnDu5FpjgOwxLTPRVGEeCyUwGSaD66eYQD94SPcw9UReTnIf2BC900TESgrlBS');
			$customer = Customer::create([
				'name' => 'test',
                'description' => 'test description',
				'email' => $email,
				'source' => $request->get('stripeToken'),
			 "address" => ["city" => "mohali", "country" =>"hri", "line1" => "Azad", "line2" => "", "postal_code" => 160055, "state" => "up"]
			]);		
